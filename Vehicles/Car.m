...
// private method implementations (as superclass doesn't have a start method as not all vehicles require starting)
-(NSString *)start {
    return [NSString stringWithFormat:@"Start power source %@.",self.powerSource];
}

// overriding existing methods in superclass
-(NSString *)goForward {
